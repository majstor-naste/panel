...
echo getCreditsByUser($logged_user);
...
echo '        </ul>' . "\n" . '      </div>' . "\n" . '    </nav>' . "\n" . '  </header>' . "\n" . '  <!-- Left side column. contains the logo and sidebar -->' . "\n" . '  <aside class="main-sidebar">' . "\n" . '    <!-- sidebar: style can be found in sidebar.less -->' . "\n" . '    <section class="sidebar">' . "\n" . '      <!-- sidebar menu: : style can be found in sidebar.less -->' . "\n" . '      <ul class="sidebar-menu" data-widget="tree">' . "\n" . '        <li class="header">MENU PRINCIPAL</li>' . "\n" . '        <li>' . "\n" . '          <a href="dashboard.php">' . "\n" . '            <i class="fa fa-dashboard"></i> <span>Painel</span>' . "\n" . '          </a>' . "\n" . '        </li>' . "\n" . '        <li class="treeview">' . "\n" . '          <a href="#">' . "\n" . '            <i class="fa fa-bug"></i>' . "\n" . '            <span>Criar teste</span>' . "\n" . '            <span class="pull-right-container">' . "\n" . '              <i class="fa fa-angle-left pull-right"></i>' . "\n" . '            </span>' . "\n" . '          </a>' . "\n" . '          <ul class="treeview-menu">' . "\n" . '            <li><a href="create_test.php"><i class="fa fa-circle-o"></i> Customizado<hr style="margin-bottom: 0px; margin-top: 10px; border-top: 1px solid #f39c12;"/></a></li>' . "\n" . '            ';
...
echo ' >Vermelho Light</option>' . "\n" . '                    </select>' . "\n" . '                  </div>' . "\n" . '                  <button type="submit" name="save_geral_settings" class="btn btn-flat ';
injectBtnColor();
...
echo '</textarea>' . "\n" . '                  </div>' . "\n" . '                  <button type="submit" name="save_fixed_informations" class="btn btn-flat ';
injectBtnColor();
...
echo '                    </select>' . "\n" . '                  </div>' . "\n" . '                  <button type="submit" name="save_allowed_groups" class="btn btn-flat ';
injectBtnColor();
...
echo '                    </select>' . "\n" . '                  </div>' . "\n" . '                  <button type="submit" name="save_allowed_bouquets" class="btn btn-flat ';
injectBtnColor();
...
echo '">' . "\n" . '                    </div>' . "\n" . '                  </div>' . "\n\n" . '                  <button type="submit" name="save_automatic_test" class="btn btn-flat ';
injectBtnColor();
...
echo '> SSL' . "\n" . '                          </label>' . "\n" . '                        </div>' . "\n" . '                      </div>' . "\n" . '                    </div>' . "\n" . '                    <div class="col-md-12">' . "\n" . '                      <button type="submit" name="save_email_settings" class="btn btn-flat ';
injectBtnColor();
...
echo '</textarea>' . "\n" . '                      </div>' . "\n" . '                    </div>' . "\n" . '                    <div class="col-md-12">' . "\n" . '                      <button type="submit" name="save_email_messages" class="btn btn-flat ';
injectBtnColor();

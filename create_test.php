<?php
	...
	if (isset($_POST['username']) && isset($_POST['password']) && isset($_POST['duration']) && isset($_POST['reseller_notes']) && isset($_POST['bouquet'])) {
		...
		if (is_array($bouquet)) {
			...
			if (createClient($logged_user['id'], $username, $password, $duration, $bouquet, $reseller_notes, 1)) {
									...
									<div class="row">
										...
										<!--div class="form-group col-md-12">
											...
											<div class="custom-control custom-radio" style="padding-left: 50px;">
												<input class="custom-control-input" type="radio" name="duration" value="1" id="customRadio2" checked>
												<label for="customRadio2" class="custom-control-label" style="padding-left: 0;"><?php echo $test_time; ?> hora(s)</label><br>
												<input class="custom-control-input" type="radio" name="duration" value="2" id="customRadio2">
												<label for="customRadio2" class="custom-control-label" style="padding-left: 0;">EM TESTE NÃO USE</label>
											</div>
										</div-->
										<div class="form-group col-md-12">

						...
						<div class="row mb-2">
							...
							<div class="col-sm-6">
								<ol class="breadcrumb float-sm-right">
									...
									<li class="breadcrumb-item active">Novos Filmes</li>
								</ol>
							</div>
						</div>
					</div>
					...
					<div class="container-fluid">
						...
						<div class="card">
							<div class="card-header">
								<h3 class="card-title">Novos Filmes</h3>
							...
							<div class="card-body">
								<table id="table" class="table table-bordered table-striped">
									...
									<tbody>
										<?php
											$last_movies = getLastMovies(28);
											foreach($last_movies as $current_movie) {
											$current_movie['added'] = !empty($current_movie['added']) ? date('d/m/Y', $current_movie['added']) : '';
											?>
										<tr>
											<td><?php echo $current_movie['stream_display_name'];?></td>
											<td><?php echo getCategorieByID($current_movie['category_id']);?></td>
											<td><?php echo $current_movie['added'];?></td>
										</tr>
										<?php }; ?>
									</tbody>
									<tfoot>

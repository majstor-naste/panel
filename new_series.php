						...
						<div class="row mb-2">
							...
							<div class="col-sm-6">
								<ol class="breadcrumb float-sm-right">
									...
									<li class="breadcrumb-item active">Novos Séries</li>
								</ol>
							</div>
						</div>
					</div>
					...
					<div class="container-fluid">
						...
						<div class="card">
							<div class="card-header">
								<h3 class="card-title">Novos Séries</h3>
							...
							<div class="card-body">
								<table id="table" class="table table-bordered table-striped">
									...
									<tbody>
										<?php
											$last_series = getLastSeries(28);
											foreach($last_series as $current_serie) {
											$current_serie['last_modified'] = !empty($current_serie['last_modified']) ? date('d/m/Y', $current_serie['last_modified']) : '';
											?>
										<tr>
											<td><?php echo $current_serie['title'];?></td>
											<td><?php echo getCategorieByID($current_serie['category_id']);?></td>
											<td><?php echo $current_serie['last_modified'];?></td>
										</tr>
										<?php }; ?>
									</tbody>
									<tfoot>
